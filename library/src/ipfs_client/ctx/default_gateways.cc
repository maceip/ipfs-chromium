...
void ctx::LoadStaticGatewayList(ipfs::ctx::GatewayConfig& cfg) {
  auto static_list = {
      std::pair<std::string_view, int>{"http://127.0.0.1:8080/", 1027},
      {"https://ipfs.io/", 987},
      {"https://dweb.link/", 928},
      {"https://trustless-gateway.link/", 925},
      {"https://hardbin.com/", 887},
      {"https://ipfs.greyh.at/", 846},
      {"https://ipfs.joaoleitao.org/", 825},
      {"https://dlunar.net/", 666},
      {"https://flk-ipfs.io/", 651},
      {"https://ipfs.cyou/", 451},
      {"https://human.mypinata.cloud/", 399},
      {"https://jcsl.hopto.org/", 342},
      {"https://delegated-ipfs.dev/", 294},
      {"https://4everland.io/", 285},
      {"https://ipfs.runfission.com/", 240},
      {"https://gateway.pinata.cloud/", 125},
      {"https://dag.w3s.link/", 121},
      {"https://flk-ipfs.xyz/", 114},
      {"https://ipfs.eth.aragon.network/", 25},
